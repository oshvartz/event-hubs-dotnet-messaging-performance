    ...
    public class ProcessorTask : PerformanceTask
    {
        ...
        public ProcessorTask(CliOptions options, ILogger<CustomProcessor> logger) : base(options)
        {
            ...
            new CustomProcessor(logger, storageClient,
                                ...
                                new Azure.Messaging.EventHubs.Primitives.EventProcessorOptions { DefaultStartingPosition = EventPosition.Earliest, PrefetchCount = options.PrefetchCount , MaximumWaitTime = null })).ToList();
        }
